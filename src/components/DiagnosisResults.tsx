...
export function DiagnosisResults() {
  ...
  const getImprovementColor = (rate: string) =>
    rate.startsWith("+") ? "text-green-600" : "text-red-600";
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div className="text-2xl font-semibold">
                {summary.stableRatio?.toFixed(1) ?? "0"}%
              </div>
            )}
            {!loadingSummary && (
        ...
        <Card>
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div className="text-2xl font-semibold">
                {summary.totalAssessments?.toLocaleString() ?? "0"}
              </div>
            )}
            {!loadingSummary && (
              <p className="text-sm text-muted-foreground">최근 3개월</p>
        ...
        <Card>
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div className="text-2xl font-semibold">
                {summary.avgAssessmentIntervalDays?.toFixed(1) ?? "0"}일
              </div>
            )}
            {!loadingSummary && (
      ...
      <Card>
        <CardHeader>
          <CardTitle>최근 7일 설문 사용자</CardTitle>
        </CardHeader>
        <CardContent>
          {loadingUsers ? (
            <div className="flex justify-center py-12">
